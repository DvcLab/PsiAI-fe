...
<template>
    <div class="grid-item-con">
        ...
        <a href="javascript:void(0);">
            <img class="grid-img" src="@/assets/images/companies/img-1.png" v-real-img="dataset.cover_img_url" alt="项目"/>
            <div class="grid-body">
        ...
        <div class="grid-footer">
            <!-- 暂时点击用户头像跳转空链接 -->
            <a href="javascript:void(0);">
                <img v-if="dataset.user" class="grid-avatar float-start" src="@/assets/images/users/avatar-1.jpg" v-real-img="dataset.user.avatar_url" :alt="dataset.user.username" />
            </a>
            <span class="grid-time float-end">{{ dataset.update_time | moment("from", "now") }}</span>
        </div>
    </div>
</template>
